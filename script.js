const gifStages = CONFIG.gifStages;
const noMessages = CONFIG.noMessages;
const yesTeasePokes = CONFIG.yesTeasePokes;

// Apply config immediately since script is at the bottom of the body
document.getElementById('page-title').textContent = CONFIG.pageTitle;
document.getElementById('main-heading').textContent = CONFIG.heading;
...
document.getElementById('cat-gif').src = CONFIG.initialGif;
