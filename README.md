...
**Live demo:** [github.com/kingsheartz/my-sweetheart.git](https://github.com/kingsheartz/my-sweetheart.git)
...
```
https://github.com/kingsheartz/my-sweetheart.git
```
...
- Go to [github.com/kingsheartz/my-sweetheart.git](https://github.com/kingsheartz/my-sweetheart.git)
...
- Your site will be live at:
  ```
  https://yourusername.github.io/my-sweetheart.git
  ```
